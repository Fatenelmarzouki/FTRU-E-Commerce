...
dash.addEventListener('click',function (){
    ...
    console.log(!dash.classList.contains("active"));
});
...
order.addEventListener('click',function (){
    ...
    console.log(!order.classList.contains("active"));
});
...
product.addEventListener('click',function (){
    ...
    console.log(!product.classList.contains("active"));
});
...
cate.addEventListener('click',function (){
    ...
    console.log(!cate.classList.contains("active"));
});
...
custumer.addEventListener('click',function (){
    ...
    console.log(!custumer.classList.contains("active"));
});