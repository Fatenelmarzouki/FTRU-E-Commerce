    ...
    <body style=" background-color: #E9E8DE; border-radius: 25px; padding: 30px 0px">
        <section class="receipt_container">
            ...
            <div class="description">
                <p>Thank you for choosing FTRU Store! We appreciate your business. Below is the receipt for your recent transaction</p>
            </div>
            <div class="products">
            ...
            <div class="description">
                <p>If you have any questions or concerns regarding this transaction, please don't hesitate to contact us at</p>
