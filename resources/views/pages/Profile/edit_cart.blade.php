                ...
                <div class="edit_list">
                    <div>
                        <div class="image_cont">
                            <img src="{{asset("storage/$productCS->image")}}" alt="">
                        </div>
                    ...
                    {{-- form --}}
                    <form class="form_product_edit" action="{{route('handle edit cart',$cart_item->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="price_container">
                            ...
                            <input class="num" type="number" name="quantity" value="{{$cart_item->quantity}}" min="1">
                        </div>
